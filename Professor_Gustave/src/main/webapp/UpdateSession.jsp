...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="profile.jsp?email">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="col-lg-6 col-md-8">
                <div class="card card-plain">
                    <div class="card-header pb-0 text-left bg-transparent">
                        <h3 class="font-weight-bolder text-info text-gradient">Update Session</h3>
                        <p class="mb-0">Fill in the details for the new session</p>
                    </div>
                    <div class="card-body px-lg-5 py-lg-5">
                        <form role="form" action="/UpdateSession" method="post">
                            <!-- Subject selection -->
                            ...
                            <% int idsession = (int) application.getAttribute("idsession");%>
                            <input type="hidden" value="<%=idsession%>" name="id"/>
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary btn-lg btn-block" href="sessions.jsp?email=<%= Email %>">Update Session</button>
                            </div>
                        </form>
                    </div>
                </div>
