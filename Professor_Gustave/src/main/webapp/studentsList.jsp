...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
  ...
  <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link text-white active bg-gradient-primary" href="sessions.jsp">
...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
  ...
  <div class="container-fluid py-4">
    <div class="row">
      ...
      <% int booked_students= Session_Crud.getNbStudentBooked(id) ;
        int waitlistStudents= Session_Crud.getNbStudentsWaitList(id);
      %>
      <!-- Students Booked Section -->
      <div class="col-lg-6 col-md-12">
        <div class="card my-4">
          <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
              <h6 class="text-white text-capitalize ps-3">Number of Students Booked :<%=booked_students%></h6>
            </div>
          </div>
        </div>
      </div>
      <div class="col-lg-12">
        <div class="text-center my-4">
          <form action="/Update_WaitList" method="post">
            <input type="hidden" name="id" value="<%=Integer.parseInt(request.getParameter("sessionid")) %>">
      ...
      <div class="col-lg-6 col-md-12">
        <div class="card my-4">
          <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
              <h6 class="text-white text-capitalize ps-3">Number of Students in Waitlist : <%=waitlistStudents%></h6>
            </div>
          </div>
        </div>
      </div>
